    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "bg-white/95 text-slate-800 backdrop-blur-md shadow-md py-2 border-b border-purple-100"
            : "bg-slate-950/65 text-white backdrop-blur-xl py-4"
        }`}
      >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden xl:flex items-center space-x-6">
              {navItems.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className={`font-medium text-sm transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-current hover:after:w-full after:transition-all ${
                    scrolled ? "text-gray-700 hover:text-primary" : "text-white hover:text-cyan-200"
                  }`}
                >
                  {item.name}
                </a>
            ...
            <div className="hidden lg:flex items-center space-x-3">
              ...
              <a
                ...
                className={`flex items-center space-x-1.5 px-3.5 py-1.5 rounded-full font-semibold text-xs transition-all hover:scale-105 ${
                  scrolled
              ...
              <a
                ...
                className={`px-4 py-2 rounded-full font-semibold text-xs shadow-sm transition-all ${
                  scrolled
            ...
            <div className="lg:hidden">
              <button
                ...
                className={`focus:outline-none p-2 rounded-lg hover:bg-white/10 ${scrolled ? "text-gray-800" : "text-white"}`}
              >
